                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex space-x-1">
                                ...
                                @else
                                    <a href="{{ $tiposContribucion->previousPageUrl() }}" class="px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition duration-200">Anterior</a>
                                @endif

                                {{-- First Page --}}
                                @if($tiposContribucion->currentPage() > 3)
                                    <a href="{{ $tiposContribucion->url(1) }}" class="px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition duration-200">1</a>
                                ...
                                @for ($page = $start; $page <= $end; $page++)
                                    ...
                                    @else
                                        <a href="{{ $tiposContribucion->url($page) }}" class="px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition duration-200">{{ $page }}</a>
                                    @endif
                                @endfor
                                ...
                                @if($tiposContribucion->currentPage() < $tiposContribucion->lastPage() - 2)
                                    @if($tiposContribucion->currentPage() < $tiposContribucion->lastPage() - 3)
                                        <span class="px-2 py-2 text-sm text-gray-500">...</span>
                                    @endif
                                    <a href="{{ $tiposContribucion->url($tiposContribucion->lastPage()) }}" class="px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition duration-200">{{ $tiposContribucion->lastPage() }}</a>
                                @endif

                                {{-- Next Page Link --}}
                                @if ($tiposContribucion->hasMorePages())
                                    <a href="{{ $tiposContribucion->nextPageUrl() }}" class="px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-100 transition duration-200">Siguiente</a>
                                @else
