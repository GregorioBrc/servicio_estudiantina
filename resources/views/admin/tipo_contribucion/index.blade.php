<x-app-layout title="Tipos de Contribución">
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <!-- Search Form -->
            <div class="mb-8">
                <form method="GET" action="{{ route('admin.tipo_contribuciones.index') }}" class="flex flex-col md:flex-row gap-4">
                    <div class="flex-grow">
                        <input
                            type="text"
                            name="search"
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition duration-200 placeholder-gray-500"
                        >
                    </div>
                    <div class="flex gap-2">
                        <button
                            type="submit"
                            class="bg-yellow-600 hover:bg-yellow-700 text-white px-6 py-2 rounded-lg shadow transition duration-200 flex items-center gap-2"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @if(request('search'))
                        <a
                            href="{{ route('admin.tipo_contribuciones.index') }}"
