                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-lg border border-blue-200">
                        <div class="flex items-center">
                            ...
                            <div>
                                <a href="{{ route('admin.autores.show', $contribucion->autor) }}"
                                    class="font-medium text-gray-900 hover:text-green-700 hover:underline">
                                    {{ $contribucion->autor->nombre ?? 'Sin autor' }}
                                </a>
                                <div class="text-sm text-gray-500">
                                    <a href="{{ route('admin.obras.show', $contribucion->obra) }}"
                                        class="hover:text-indigo-700 hover:underline">
                                        {{ $contribucion->obra->titulo ?? 'Sin obra' }}
                                    </a>
                                </div>
                            </div>
                        </div>
