<x-app-layout title="Editar Tipo de Contribución">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between mb-12 gap-4">
                <div class="text-center sm:text-left">
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Editar Tipo de Contribución</h1>
                    <p class="text-lg text-gray-600">Modificar {{ $tipoContribucion->nombre_contribucion }}</p>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('admin.tipo_contribuciones.show', $tipoContribucion) }}" class="bg-gradient-to-r from-purple-500 to-purple-600 text-white px-6 py-3 rounded-lg shadow-lg hover:from-purple-600 hover:to-purple-700 transition duration-300 flex items-center gap-2 font-medium">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white shadow-lg rounded-xl p-8 border-t-4 border-yellow-500">
                ...
                <form method="POST" action="{{ route('admin.tipo_contribuciones.update', $tipoContribucion) }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" id="nombre_contribucion" name="nombre_contribucion" value="{{ old('nombre_contribucion', $tipoContribucion->nombre_contribucion) }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition duration-200" required>
                    ...
                    <div class="flex justify-end">
                        <button type="submit" class="bg-gradient-to-r from-yellow-500 to-orange-600 text-white px-6 py-3 rounded-lg hover:from-yellow-600 hover:to-orange-700 transition duration-300 font-medium shadow-lg">
                            Actualizar Tipo de Contribución
                        </button>
                    </div>
                </form>
            </div>
