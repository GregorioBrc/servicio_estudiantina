<x-app-layout title="Editar Instrumento">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between mb-12 gap-4">
                <div class="text-center sm:text-left">
                    <h1 class="text-4xl font-bold text-gray-900 mb-2">Editar Instrumento</h1>
                    <p class="text-lg text-gray-600">Modificar información de {{ $instrumento->nombre }}</p>
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('admin.instrumentos.show', $instrumento) }}" class="bg-gradient-to-r from-purple-500 to-purple-600 text-white px-6 py-3 rounded-lg shadow-lg hover:from-purple-600 hover:to-purple-700 transition duration-300 flex items-center gap-2 font-medium">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="bg-white shadow-lg rounded-xl p-8 border-t-4 border-yellow-500">
                ...
                <form method="POST" action="{{ route('admin.instrumentos.update', $instrumento) }}" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $instrumento->nombre) }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition duration-200" required>
                        ...
                        <div>
                            <label for="tipo" class="block text-sm font-medium text-gray-700 mb-2">Tipo de Instrumento</label>
                            <div class="relative">
                                <input type="text" id="tipo" name="tipo" value="{{ old('tipo', $instrumento->tipo) }}" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition duration-200" required>
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center">
                                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
