<x-app-layout title="Editar Subtipo de Instrumento - UNET">
        ...
        <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 p-6 bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl shadow-2xl border border-gray-700 animate-fade-in">
                <div class="flex items-center mb-4 md:mb-0">
                    ...
                    <div>
                        <h1 class="text-3xl md:text-4xl font-bold text-white">Editar Subtipo de Instrumento</h1>
                        <p class="text-yellow-300 mt-1">Modificar categoría musical - UNET</p>
                    </div>
                </div>
            ...
            <div class="bg-gray-800 rounded-2xl shadow-2xl overflow-hidden border border-gray-700 transition-all duration-300 hover:shadow-3xl">
                ...
                <div class="bg-gradient-to-r from-gray-900 to-gray-800 p-4 border-b border-gray-700">
                    <div class="flex justify-between items-center">
                        <h2 class="text-xl font-semibold text-white flex items-center">
                            <i class="fas fa-edit mr-2 text-yellow-400"></i>Formulario de Edición
                        </h2>
                ...
                <form action="{{ route('subtipo_instrumento.update', $subtipoInstrumento) }}" method="POST" class="px-6 py-8">
                    @csrf
                    @method('PUT')

                    <!-- Nombre Field -->
                    <div class="mb-6 group">
                        <label for="nombre" class="block text-yellow-300 text-sm font-semibold mb-2 flex items-center">
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                name="nombre"
                                id="nombre"
                                value="{{ old('nombre', $subtipoInstrumento->nombre) }}"
                                class="w-full pl-10 pr-3 py-4 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition duration-300 ease-in-out text-white placeholder-gray-400 focus:outline-none focus:ring-opacity-50 focus:shadow-lg focus:shadow-yellow-500/30"
                                placeholder="Ej. Piano de cola, Violín eléctrico..."
                                required
                            >
                        </div>
                        <p class="mt-2 text-sm text-gray-400">Modifica el nombre descriptivo para el subtipo de instrumento</p>
                    </div>

                    <!-- Descripcion Field -->
                    <div class="mb-6 group">
                        <label for="descripcion" class="block text-yellow-300 text-sm font-semibold mb-2 flex items-center">
                        ...
                        <div class="relative">
                            ...
                            <textarea
                                ...
                                rows="4"
                                class="w-full pl-10 pr-3 py-4 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition duration-300 ease-in-out text-white placeholder-gray-400 focus:outline-none focus:ring-opacity-50 focus:shadow-lg focus:shadow-yellow-500/30"
                                placeholder="Describe las características principales de este subtipo...">{{ old('descripcion', $subtipoInstrumento->descripcion) }}</textarea>
                        </div>
                        <p class="mt-2 text-sm text-gray-400">Actualiza los detalles sobre las características especiales de este subtipo</p>
                    </div>

                    <!-- Instrumento Field -->
                    <div class="mb-8 group">
                        <label for="instrumento_id" class="block text-yellow-300 text-sm font-semibold mb-2 flex items-center">
                        ...
                        <div class="relative">
                            ...
                            <select
                                name="instrumento_id"
                                id="instrumento_id"
                                class="w-full pl-10 pr-3 py-4 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 transition duration-300 ease-in-out text-white focus:outline-none focus:ring-opacity-50 focus:shadow-lg focus:shadow-yellow-500/30 appearance-none"
                                required>
                                <option value="" disabled>Selecciona un instrumento principal</option>
                                @foreach($instrumentos as $instrumento)
                                    <option value="{{ $instrumento->id }}" {{ old('instrumento_id', $subtipoInstrumento->instrumento_id) == $instrumento->id ? 'selected' : '' }}>
                                        {{ $instrumento->nombre }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="flex items-center justify-between pt-4">
                        <button
                            type="submit"
                            class="group bg-gradient-to-r from-yellow-600 to-amber-700 hover:from-yellow-700 hover:to-amber-800 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:-translate-y-1 inline-flex items-center text-lg">
                            <i class="fas fa-sync-alt mr-3 group-hover:rotate-180 transition-transform duration-500"></i> Actualizar Subtipo
                        </button>
